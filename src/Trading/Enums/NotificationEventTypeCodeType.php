...
class NotificationEventTypeCodeType extends Enum 
{
    ...
    const C_M2_M_MESSAGE_STATUS_CHANGE = 'M2MMessageStatusChange';
    const C_MY_MESSAGES_EBAY_MESSAGE = 'MyMessageseBayMessage';
    const C_MY_MESSAGES_EBAY_MESSAGE_HEADER = 'MyMessageseBayMessageHeader';
    ...
    const C_MY_MESSAGES_M2_M_MESSAGE = 'MyMessagesM2MMessage';
    const C_MY_MESSAGES_M2_M_MESSAGE_HEADER = 'MyMessagesM2MMessageHeader';
    const C_NONE = 'None';
    ...
    const C_USER_ID_CHANGED = 'UserIDChanged';
